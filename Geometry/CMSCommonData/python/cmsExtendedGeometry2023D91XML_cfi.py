...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/MTDData/data/btl.xml',
        'Geometry/MTDData/data/etl.xml',
        'Geometry/MTDData/data/CrystalBar/mtd.xml',
        'Geometry/MTDData/data/mtdsens.xml',
        'Geometry/MTDData/data/mtdProdCuts.xml',
