...
XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = cms.vstring(
        ...
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/pixfwd.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/pixbar.xml',
        'Geometry/TrackerCommonData/data/trackermaterial.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/tracker.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/pixel.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/pixbar.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/pixfwd.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/trackerbar.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/trackerfwd.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/trackerStructureTopology.xml',
        'Geometry/TrackerCommonData/data/PhaseII/TiltedTracker4026new/pixelStructureTopology.xml',
        'Geometry/TrackerSimData/data/PhaseII/TiltedTracker4026new/trackersens.xml',
        'Geometry/TrackerSimData/data/PhaseII/TiltedTracker4026new/pixelsens.xml',
        'Geometry/TrackerRecoData/data/PhaseII/TiltedTracker4026new/trackerRecoMaterial.xml',
        'Geometry/TrackerSimData/data/PhaseII/TiltedTracker4026new/trackerProdCuts.xml',
        'Geometry/TrackerSimData/data/PhaseII/TiltedTracker4026new/pixelProdCuts.xml',
