...
namespace Rivet
{
  ...
  class CMS_SMP_12_017_acceptance:public Analysis
  {
  public:

    /// Constructor
    CMS_SMP_12_017_acceptance():Analysis("CMS_SMP_12_017_acceptance")
    {
  ...
  public:
    ...
    void analyze(const Event & event)
    {
          ...
          if (Id == ELECTRON && fabs(eta) < 999.)
            {
              ...
              if (ele_dres.lepton_photon.empty() && ele_p.pT() > 0.)
                {
                ...
                {
                  if (ele_p.pT() > ele_dres.p_part.pT() && ele_p.pT() > 0.)
                    {
                      ele_dres.p_part = ele_p;
                      ele_dres.lepton_photon = ele_photons;
                    }
          ...
          if (Id == POSITRON && fabs(eta) < 999.)
            {
              ...
              if (pos_dres.lepton_photon.empty() && pos_p.pT() > 0.)
                {
                ...
                {
                  if (pos_p.pT() > pos_dres.p_part.pT() && pos_p.pT() > 0.)
                    {
                      pos_dres.p_part = pos_p;
                      pos_dres.lepton_photon = pos_photons;
                    }
          ...
          if (Id == MUON && fabs(eta) < 999.)
            {
              ...
              if (muon_dres.lepton_photon.empty() && muon_p.pT() > 0.)
                {
          ...
          if (Id == ANTIMUON && fabs(eta) < 999.)
            {
              ...
              if (antimuon_dres.lepton_photon.empty() && muon_p.pT() > 0.)
                {
      ...
      // Z mass window
      if ((Z_momentum_ele.mass() > 60. && Z_momentum_ele.mass() < 120.) && (!ele_dres.lepton_photon.empty() && !pos_dres.lepton_photon.empty()))
        {
          Z_ele = true;
      ...
      if ((Z_momentum_muon.mass() > 60. && Z_momentum_muon.mass() < 120.) && (!muon_dres.lepton_photon.empty() && !antimuon_dres.lepton_photon.empty()))
        {
          Z_muon = true;
  ...
  AnalysisBuilder<CMS_SMP_12_017_acceptance> plugin_CMS_SMP_12_017_acceptance;
