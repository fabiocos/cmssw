...
namespace reco {
  ...
  public:
    ...
    TrackTransientTrack(const TrackRef& tk,
                        ...
                        const int npixbarrel,
                        const int npixendcap);
   ...
   */
    ...
    float btlMatchTime_chi2() const override {
      return (hasTime ? btltimechi2_ : std::numeric_limits<double>::quiet_NaN());
    }
    float etlMatch_chi2() const override { return (hasTime ? etlchi2_ : std::numeric_limits<double>::quiet_NaN()); }
    float etlMatchTime_chi2() const override {
      return (hasTime ? etltimechi2_ : std::numeric_limits<double>::quiet_NaN());
    }
    ...
    float sigma_time_pi() const override {
      return (hasTime ? sigma_time_pi_ : std::numeric_limits<double>::quiet_NaN());
    }
  ...
  private:
    ...
    float mva_;
    float pathlength_;
    float btlchi2_, btltimechi2_, etlchi2_, etltimechi2_, time_pi_, time_k_, time_p_, sigma_time_pi_, sigma_time_k_,
        sigma_time_p_;
